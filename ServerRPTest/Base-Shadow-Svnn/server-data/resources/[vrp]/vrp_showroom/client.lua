...
local vehshop = {
	...
	menu = {
		...
		["Principal"] = {
			...
			name = "Principal",
			buttons = {
				{name = "Automoveis", description = ""},
				{name = "Motocicletas", description = ""},
			}
		},
		["Automoveis"] = {
			title = "Automoveis",
		...
		["Populares"] = {
			...
			name = "Populares",
			buttons = {
				{name = "Astra", costs = 15000, description = {}, model = "astraj"},
				{name = "Mini Cooper", costs = 15000, description = {}, model = "cooperworks"},
				{name = "Prius", costs = 25000, description = {}, model = "prius"},
...
function vehSR_ButtonSelected(button)
	...
	if this == "Principal" then
		if btn == "Automoveis" then
			vehSR_OpenMenu('Automoveis')
		elseif btn == "Motocicletas" then
			vehSR_OpenMenu('Motocicletas')
		end
	elseif this == "Automoveis" then
		if btn == "sports" then
...
function vehSR_OpenMenu(menu)
	...
	if menu == "Automoveis" then
		vehshop.lastmenu = "Principal"
